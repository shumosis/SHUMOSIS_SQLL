...
select * from state_details  order by  nam  ;
...
select count(*) as srno from state_details ;
...
select min(disricts) from state_details;

select * from state_details;

select avg(srno) from state_details;
select avg(famous) from state_details;
select avg(disricts) from state_details;

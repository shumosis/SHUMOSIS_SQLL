...
select age ,player_name,count(player_name) from Kabbadi_players group by age;
select age ,player_name,sum(player_name) from Kabbadi_players group by age;
select age ,player_name,min(player_name) from Kabbadi_players group by age;
select age ,player_name,max(player_name) from Kabbadi_players group by age;
select age ,player_name,avg(player_name) from Kabbadi_players group by age;


select count(player_name) as count from  Kabbadi_players group by exteam having exteam = 'BENGLURU';
select max(player_name) as max from  Kabbadi_players group by exteam having exteam = 'BENGLURU';
select min(player_name) as min from  Kabbadi_players group by exteam having exteam = 'BENGLURU';
select sum(player_name) as sum from  Kabbadi_players group by exteam having exteam = 'BENGLURU';
select avg(player_name) as avg from  Kabbadi_players group by exteam having exteam = 'BENGLURU';
